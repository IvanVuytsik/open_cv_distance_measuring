...
while True:
    ...
    if time.time() - timeStart < totalTime:
        ...
        cvzone.putTextRect(img, f'Score: {str(score).zfill(2)}', (70,75), scale=3, offset=20)
    else:
        cvzone.putTextRect(img, 'Game Over', (400,400), scale=5, offset=30, thickness=7)
        cvzone.putTextRect(img, f'Score: {score}', (530,450), scale=3, offset=20)
        cvzone.putTextRect(img, 'Press R to restart', (470,500), scale=2, offset=10)
